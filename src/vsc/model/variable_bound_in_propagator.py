    ...
    def propagate(self):
        ...
        while in_i < len(in_r_l) and dom_i < len(self.target.domain.range_l):
            ...
            if in_r_v[0] > dom_r[1]:
                ...
                if prev_in_r_v is not None and prev_in_r_v[1] >= dom_r[0] and prev_in_r_v[1] <= dom_r[1]:
