...
from vsc1.constraints import weight
from vsc1.impl import expr_mode
from vsc1.impl.ctor import push_constraint_scope, pop_constraint_scope
from vsc1.impl.expr_mode import enter_raw_mode, leave_raw_mode, enter_expr_mode, \
    leave_expr_mode
...
from vsc1.types import field_info, type_base
...
def randomize_with(*args, **kwargs):
    ...
    for v in args:
        if not hasattr(v, "get_model"):
            raise Exception("Parameter \"" + str(v) + " to randomize is not a vsc1.object")
