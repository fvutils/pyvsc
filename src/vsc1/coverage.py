...
from vsc1.impl.covergroup_int import CovergroupInt
from vsc1.impl.ctor import pop_expr
from vsc1.impl.expr_mode import expr_mode
from vsc1.impl.options import Options
from vsc1.impl.type_options import TypeOptions
...
from vsc1.model.coverpoint_bin_enum_model import CoverpointBinEnumModel
from vsc1.model.coverpoint_bin_single_bag_model import CoverpointBinSingleBagModel
from vsc1.model.coverpoint_bin_single_val_model import CoverpointBinSingleValModel
...
from vsc1.types import rangelist, bit_t, to_expr, type_base, enum_t, type_enum, \
    expr, field_info
from vsc1.impl.wildcard_bin_factory import WildcardBinFactory
from vsc1.model.coverpoint_bin_single_wildcard_model import CoverpointBinSingleWildcardModel
from vsc1.model.wildcard_binspec import WildcardBinspec
        ...
        def with_sample(self, *args, **kwargs):
            ...
            for pn,pt in params.items():
                if hasattr(pt, "_int_field_info"):
                    ...
                    raise Exception("Sample arguments must vsc1.objects, not " + str(pt))
#             elif len(kwargs) > 0:
