...
from vsc1.impl.ctor import push_expr, pop_expr, in_constraint_scope, \
    is_foreach_arr, expr_l, in_srcinfo_mode
from vsc1.impl.enum_info import EnumInfo
from vsc1.impl.expr_mode import is_expr_mode
...
from vsc1.model.expr_array_sum_model import ExprArraySumModel
...
from vsc1.model.expr_indexed_field_ref_model import ExprIndexedFieldRefModel
...
from vsc1.model.expr_range_model import ExprRangeModel
from vsc1.model.expr_rangelist_model import ExprRangelistModel
from vsc1.model.expr_unary_model import ExprUnaryModel
from vsc1.model.field_array_model import FieldArrayModel
from vsc1.model.field_const_array_model import FieldConstArrayModel
from vsc1.model.field_scalar_model import FieldScalarModel
from vsc1.model.unary_expr_type import UnaryExprType
from vsc1.model.value_scalar import ValueScalar, ValueInt


from vsc1.impl.expr_mode import get_expr_mode, expr_mode, is_expr_mode
from vsc1.model.expr_array_product_model import ExprArrayProductModel
from vsc1.visitors.model_pretty_printer import ModelPrettyPrinter
from vsc1.model.expr_indexed_dynref_model import ExprIndexedDynRefModel
    ...
    def inside(self, rhs):
        ...
        if isinstance(rhs, rangelist):
            ...
            raise Exception("Unsupported 'inside' argument of type " + str(type(rhs)) + 
                            "expect vsc1.rangelist or list_t")
