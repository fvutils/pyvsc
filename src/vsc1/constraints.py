...
from vsc1.impl.ctor import push_constraint_scope, push_constraint_stmt, pop_expr, \
...
from vsc1.model.constraint_dist_model import ConstraintDistModel
...
from vsc1.model.constraint_solve_order_model import ConstraintSolveOrderModel
...
from vsc1.model.expr_dynref_model import ExprDynRefModel
...
from vsc1.types import to_expr, expr, type_base, rng
from vsc1.visitors.expr2fieldtype_visitor import Expr2FieldTypeVisitor
...
def dist(lhs, weights):
    ...
    for w in weights:
        if not isinstance(w, weight):
            raise Exception("Weight specifications must of type 'vsc1.weight', not " + 
                            str(w))
